...
class SPSE_ResNet(nn.Module):
    def __init__(self, block, layers, num_classes = 1000):
        self.inplanes = 64
        super(SPSE_ResNet, self).__init__()
...
def resnet50_spse():
    return SPSE_ResNet(Bottleneck,[3,4,6,3])

def resnet101_spse():
    return SPSE_ResNet(Bottleneck,[3,4,23,3])

def resnet152_spse():
    return SPSE_ResNet(Bottleneck,[3,8,36,3])